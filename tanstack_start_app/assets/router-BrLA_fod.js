...
const LangContext = reactExports.createContext({ lang: "pt", toggle: () => {
} });
...
const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$6);
const __iconNode$5 = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 md:px-10 py-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:inline font-mono text-[11px] uppercase tracking-[0.3em] text-muted-foreground", children: t({ pt: "Paraisópolis · MG", en: "Paraisópolis · BR" }, lang) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                onClick: toggle,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex fixed right-6 top-1/2 -translate-y-1/2 z-40 flex-col gap-3 items-end", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => go(l.id),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-0 group-hover:opacity-100 transition", children: t(l.label, lang) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: l.n }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden fixed inset-0 top-[60px] z-40 bg-background border-t border-foreground/10 px-6 py-8 flex flex-col gap-5", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => go(l.id),
        className: "text-left font-display text-3xl font-bold flex items-baseline gap-3",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-primary", children: l.n }),
          t(l.label, lang)
        ]
      },
      l.id
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "home", className: "relative min-h-screen pt-28 pb-0 bg-paper overflow-hidden flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10 w-full flex-1 pb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4 font-mono text-[11px] uppercase tracking-[0.25em] text-muted-foreground mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "col-span-6 md:col-span-3", children: [
        t({ pt: "Edição", en: "Issue" }, lang),
        " N.º 01"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-6 md:col-span-3", children: (/* @__PURE__ */ new Date()).toLocaleDateString(lang === "pt" ? "pt-BR" : "en-US", {
        day: "2-digit",
        month: "long",
        year: "numeric"
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden md:block col-span-3", children: [
        t({ pt: "Disponível p/ projetos", en: "Available for work" }, lang),
        " ●"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block col-span-3 text-right", children: "UNIFEI / Versigent" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-foreground/30" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4 md:gap-8 mt-8 md:mt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold leading-[0.85] tracking-[-0.04em] text-[clamp(3rem,11vw,9rem)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "Rodrigo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "block", children: [
            "Braz",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-md font-serif italic text-2xl md:text-3xl leading-snug text-foreground/80", children: t(
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-4 relative md:pr-24", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-[280px] md:mx-0 mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-3 border-2 border-primary translate-x-3 translate-y-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: profile,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 md:mx-0 mx-auto max-w-[280px] border-t-2 border-foreground/80 pt-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[11px] uppercase tracking-[0.25em] text-muted-foreground mb-2", children: t({ pt: "Atualmente", en: "Currently" }, lang) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4 mt-16 md:mt-24 border-t border-foreground/30 pt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-3 font-mono text-[11px] uppercase tracking-[0.25em] text-muted-foreground", children: [
        "↓ ",
        ...
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[11px] text-primary", children: "/ 04" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl font-semibold", children: t({ pt: "Projetos", en: "Work" }, lang) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "w-5 h-5 text-foreground/40 group-hover:text-primary group-hover:rotate-[-45deg] transition" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[11px] text-primary", children: "/ 02" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl font-semibold", children: t({ pt: "Trajetória", en: "Journey" }, lang) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "w-5 h-5 text-foreground/40 group-hover:text-primary group-hover:rotate-[-45deg] transition" })
          ]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[11px] text-primary", children: "/ 05" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl font-semibold", children: t({ pt: "Conversar", en: "Say hi" }, lang) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "w-5 h-5 text-foreground/40 group-hover:text-primary group-hover:rotate-[-45deg] transition" })
          ]
        }
...
function SectionLabel({
  ...
  const { lang } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4 mb-12 items-end border-t border-foreground/30 pt-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-3 font-mono text-[11px] uppercase tracking-[0.3em] text-primary", children: [
      "/ ",
      n,
      " ",
      kicker && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
        "— ",
        t(kicker, lang)
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "col-span-12 md:col-span-9 font-display text-5xl md:text-7xl font-bold leading-[0.9] tracking-tight", children: t(title, lang) })
  ] });
}
function About() {
  const { lang } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-14 md:py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionLabel,
      {
        n: "01",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-6 md:gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "col-span-12 md:col-span-4 md:sticky md:top-24 md:self-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[11px] uppercase tracking-[0.25em] text-muted-foreground mb-4", children: t({ pt: "Resumo", en: "Summary" }, lang) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 font-mono text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: t({ pt: "Formação", en: "Studying" }, lang), v: "UNIFEI · 2027" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: t({ pt: "Trabalho", en: "Working" }, lang), v: "Versigent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: t({ pt: "Foco", en: "Focus" }, lang), v: "Full-stack" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: t({ pt: "Local", en: "Based in" }, lang), v: "Paraisópolis, MG" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { k: t({ pt: "Línguas", en: "Languages" }, lang), v: "PT · EN · ES" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-8 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-serif text-3xl md:text-4xl leading-[1.15] text-balance", children: [
          t(
            {
              pt: "Estudo ",
              en: "I study "
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-primary", children: t({ pt: "Sistemas de Informação", en: "Information Systems" }, lang) }),
          t(
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base leading-relaxed text-muted-foreground max-w-2xl", children: t(
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-6 pt-8 border-t border-foreground/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { n: "2027", l: { pt: "Formatura", en: "Graduation" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { n: "2+", l: { pt: "Empresas", en: "Companies" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { n: "∞", l: { pt: "Curiosidade", en: "Curiosity" } })
        ] })
      ] })
    ] })
  ] }) });
...
function Row({ k, v }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex justify-between border-b border-foreground/15 pb-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground uppercase text-[10px] tracking-widest", children: k }),
...
function Stat({ n, l }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-4xl md:text-5xl font-bold text-primary leading-none", children: n }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground mt-2", children: t(l, lang) })
  ] });
}
const recent = [
  {
...
function Item({ e }) {
  const { lang } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "grid grid-cols-12 gap-4 md:gap-8 py-8 border-t border-foreground/20 group hover:bg-secondary/40 -mx-4 md:-mx-6 px-4 md:px-6 transition", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-3 md:col-span-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-4xl md:text-6xl font-bold text-primary leading-none", children: e.year }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground mt-2", children: t(e.date, lang) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-9 md:col-span-7", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl md:text-3xl font-semibold leading-tight", children: t(e.role, lang) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif italic text-lg text-muted-foreground mt-1", children: e.company }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base leading-relaxed text-foreground/80 mt-3 max-w-xl", children: t(e.desc, lang) }),
      e.bullets && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-1 text-sm text-muted-foreground", children: e.bullets.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "·" }),
        t(b, lang)
      ] }, i)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block col-span-3 font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: e.company })
  ] });
}
function Experience() {
  const { lang } = useLang();
  const [show, setShow] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "py-14 md:py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionLabel,
      {
        n: "02",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      recent.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Item, { e }, i)),
      show && old.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Item, { e }, `o-${i}`)),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-foreground/20" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          show ? /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4" }),
...
function LevelTag({ lvl, lang }) {
  ...
  if (v === "filled")
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 bg-foreground text-background font-mono text-[10px] font-bold uppercase tracking-widest", children: label });
  if (v === "outline")
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 border border-foreground font-mono text-[10px] font-bold uppercase tracking-widest", children: label });
  if (v === "ghost")
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] italic uppercase tracking-widest text-foreground/60", children: label });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-widest text-foreground/40", children: label });
}
const rowOpacity = (lvl) => lvl >= 60 ? "" : lvl >= 35 ? "opacity-80" : "opacity-60";
function Skills() {
  const { lang } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-14 md:py-20 bg-secondary/40 bg-paper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionLabel,
      {
        n: "03",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-b border-foreground/20 py-10 md:py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-y-14 md:gap-y-16 gap-x-10 md:gap-x-12", children: [
      cats.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 md:space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-foreground pb-2 flex justify-between items-end gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg md:text-xl font-bold uppercase tracking-tighter", children: t(c.title, lang) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] uppercase tracking-widest text-foreground/60 whitespace-nowrap", children: [
            "[ ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-foreground/10", children: c.items.map((s, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm md:text-base font-mono", children: name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(LevelTag, { lvl: s.level, lang })
              ]
            },
            i
          );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-10 md:space-y-12 md:pl-8 md:border-l border-foreground/10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-mono text-xs font-bold uppercase tracking-widest text-foreground/60", children: t({ pt: "Idiomas", en: "Languages" }, lang) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: langs.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              ...
              children: [
                t(l.name, lang),
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground/40 ml-1", children: [
                  "/ ",
                  l.level
                ] })
              ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-mono text-xs font-bold uppercase tracking-widest text-foreground/60", children: t({ pt: "Soft Skills", en: "Soft Skills" }, lang) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display italic text-lg md:text-xl leading-relaxed text-foreground/90 max-w-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-foreground/40", children: t(
      {
...
function Projects() {
  const { lang } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-14 md:py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionLabel,
      {
        n: "04",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: projects.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: p.href,
        target: "_blank",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 md:col-span-1 font-mono text-[11px] text-primary", children: [
            "/ ",
            p.n
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-10 md:col-span-4 order-2 md:order-none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-4xl md:text-6xl font-bold leading-none group-hover:text-primary transition", children: p.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif italic text-base text-muted-foreground mt-2", children: p.year }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base leading-relaxed text-foreground/80 mt-4 max-w-md", children: t(p.desc, lang) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-4", children: p.tech.map((tg) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-6 relative overflow-hidden bg-secondary order-1 md:order-none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: p.img,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 bg-background/90 backdrop-blur px-2 py-1 font-mono text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition flex items-center gap-1", children: [
              t({ pt: "Visitar", en: "Visit" }, lang),
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-3 h-3" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex col-span-1 items-start justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-6 h-6 text-foreground/40 group-hover:text-primary group-hover:rotate-45 transition" }) })
        ]
      },
      p.title
    )) })
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-14 md:py-20 bg-foreground text-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4 mb-12 items-end border-t border-background/30 pt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-3 font-mono text-[11px] uppercase tracking-[0.3em] text-gold", children: [
        "/ 05 — ",
        t({ pt: "Contato", en: "Contact" }, lang)
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "col-span-12 md:col-span-9 font-display text-5xl md:text-7xl font-bold leading-[0.9]", children: t({ pt: "Vamos construir algo?", en: "Let's build something?" }, lang) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4 md:gap-8 mt-4 border-t border-background/30 pt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif italic text-2xl md:text-3xl leading-snug max-w-md text-background/90", children: t(
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 md:col-span-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "font-mono text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChannelRow,
          {
            label: "E-mail",
...
function ChannelRow({ label, href, handle }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "border-t border-background/20 last:border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      href,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "uppercase text-[11px] tracking-[0.25em] text-background/60 group-hover:text-gold", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 text-base", children: [
          handle,
          isExt && /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-4 h-4 group-hover:rotate-45 transition" })
        ] })
      ]
    }
  ) });
...
function Footer() {
  const { lang } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-foreground text-background border-t border-background/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10 py-6 grid grid-cols-12 gap-4 font-mono text-[11px] uppercase tracking-[0.25em]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "col-span-6 md:col-span-3 text-background/60", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " R. Braz"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block col-span-3 text-background/60", children: t({ pt: "Feito com React + TS", en: "Built with React + TS" }, lang) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block col-span-3 text-background/60", children: t({ pt: "Paraisópolis · MG · BR", en: "Paraisópolis · MG · BR" }, lang) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "col-span-6 md:col-span-3 text-right text-background/60", children: [
      "↑ ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#home", className: "hover:text-gold", children: t({ pt: "Voltar ao topo", en: "Back to top" }, lang) })
    ] })
  ] }) });
}
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Portfolio de Rodrigo Braz — Desenvolvedor Full Stack especializado em JavaScript, React, Node.js e desenvolvimento web moderno."
      }
    ],
    links: [
      {
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(LangContext.Provider, { value: { lang, toggle }, children: [
