...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BOvSFToU.js");
...
function createRuntimeFn(fn2, serverImpl) {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BrLA_fod.js"),
    import("./start-H1jPb7u0.js"),
